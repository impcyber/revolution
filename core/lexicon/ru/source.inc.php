...
$_lang['source_err_ae_name'] = 'Источник файлов с таким именем уже существует! Укажите другое имя.';
...
$_lang['prop_file.basePathRelative_desc'] = 'Если параметр «базовый путь» указан относительно пути установки MODx, укажите значение «Да».';
...
$_lang['prop_file.baseUrlRelative_desc'] = 'Если параметр «базовый URL» указан относительно URL установки MODx, укажите значение «Да».';
